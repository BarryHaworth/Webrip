# Manga4Life rips.
#
# A reworking of the Weeb Central (previously Manga4Life) program to deal 
# with the fact that Weeb Central no longer lists all chapters of a manga in 
# the RSS link.  This version will start at chapter 1 and crawl it to get the list of chapters.
...
# test
manga <-'One-Piece'
home <- 'https://weebcentral.com/series/01J76XY7E9FNDZ1DBBM6PBJPFK/One-Piece'
rss <- 'https://weebcentral.com/series/01J76XY7E9FNDZ1DBBM6PBJPFK/rss'
page1 <- 'https://weebcentral.com/chapters/01J76XYYR7VK2XCSHBZT8BZ4C2'

webpage <- read_html(home)
chapter_list <- xml_attrs(html_nodes(webpage,'#chapter-list'))
...
manga4life('Spy-X-Family','https://weebcentral.com/chapters/01J76XYZGT0RZBERR0T0B6Q3RF')

manga4life('Akuyaku-Reijou-Tensei-Oji-san','https://weebcentral.com/chapters/01JC51HRJMWE5F7YE86TPANYWX') # Middle Aged Villainess
manga4life('One-Piece','https://weebcentral.com/chapters/01J76XYYR7VK2XCSHBZT8BZ4C2')
